 ...
 * @OA\GET(
 *     path="/api/whatsapp.user/{id}",
 *     summary="Envoyer un message via WhatSapp",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
 ...
 *         ),
 *     ),
 *     tags={"Gestion des messages"},
*),


 * @OA\GET(
 *     path="/api/liste_message",
 ...
 * @OA\POST(
 *     path="/api/envoie_message",
 *     summary="Envoyer un message via DEBBO",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
 ...
 * @OA\DELETE(
 *     path="/api/supprimer_message/{contacter}",
 ...
 * @OA\Response(response="403", description="Forbidden"),
 * @OA\Response(response="404", description="Not Found"),
 *     @OA\Parameter(in="path", name="contacter", required=false, @OA\Schema(type="string")
 * ),
 *     @OA\Parameter(in="header", name="User-Agent", required=false, @OA\Schema(type="string")
 * ),
 *     tags={"Gestion des messages"},
...
*/
 ...
 class GestiondesmessagesAnnotationController {}
