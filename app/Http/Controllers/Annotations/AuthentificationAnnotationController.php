 ...
 * @OA\PUT(
 *     path="/api/valider/{id}",
 *     summary="Valider le compte du Personnel de santé",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
 ...
 * @OA\PUT(
 *     path="/api/invalider/{id}",
 *     summary="Invalider le compte du Personnel de santé",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
 ...
 * @OA\POST(
 *     path="/api/auth/me",
 *     summary="Les informations de l'utilisateur actuellement authentifié",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
 ...
 *     summary="Rafraichir le jeton d'accès de l'utilisateur actuellement authentifié",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
