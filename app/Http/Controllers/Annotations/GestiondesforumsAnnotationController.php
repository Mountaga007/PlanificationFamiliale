 ...
 *         ),
 *     ),
 *     tags={"Gestion des forums"},
*),


 * @OA\GET(
 *     path="/api/liste_forum",
 ...
 * @OA\POST(
 *     path="/api/update_forum/{forum_Communication}",
 ...
 * @OA\Response(response="401", description="Unauthorized"),
 * @OA\Response(response="403", description="Forbidden"),
 *     @OA\Parameter(in="path", name="forum_Communication", required=false, @OA\Schema(type="string")
 * ),
 *     @OA\Parameter(in="header", name="User-Agent", required=false, @OA\Schema(type="string")
 * ),
 *     @OA\RequestBody(
...
*/
 ...
 class GestiondesforumsAnnotationController {}
