 ...
 * @OA\GET(
 *     path="/api/Detail_commentaire_un_forum/{forumId}",
 *     summary="Liste des commentaires d'un forum",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
 ...
 *     @OA\Parameter(in="path", name="forumId", required=false, @OA\Schema(type="string")
 * ),
 ...
 * @OA\POST(
 *     path="/api/creer_commentaire_forum/{forumId}",
 *     summary="Enregistrer un commentaire",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
 ...
 * @OA\DELETE(
 *     path="/api/supprimer_commentaire/{id}",
 *     summary="Supprimer un commentaire sur un forum",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
 ...
 * @OA\POST(
 *     path="/api/update_commentaire/{commentaire}",
 *     summary="Update un commentaire sur un forum",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
...
*/
 ...
 class GestiondescommentairesAnnotationController {}
